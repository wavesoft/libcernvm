 ...
 */
int DomainKeystore::Initialize(void) {
    CRASH_REPORT_BEGIN;
    int i;
 ...
 */
int DomainKeystore::Cleanup(void) {
    CRASH_REPORT_BEGIN;
    int i;
 ...
 */
int DomainKeystore::updateAuthorizedKeystore( DownloadProviderPtr downloadProvider ) {
    CRASH_REPORT_BEGIN;
 ...
 */
 int DomainKeystore::validateDomainData ( std::string domain, std::string signature, const unsigned char * data, const int dataLen ) {
    CRASH_REPORT_BEGIN;
 ...
 */
bool DomainKeystore::isDomainValid ( std::string domain ) {
    CRASH_REPORT_BEGIN;
 ...
 */
std::string DomainKeystore::generateSalt() {
    CRASH_REPORT_BEGIN;
 ...
 */
int DomainKeystore::signatureValidate( std::string& domain, std::string& salt, ParameterMapPtr data ) {
    CRASH_REPORT_BEGIN;
